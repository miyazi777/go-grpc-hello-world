...
var file_hello_proto_rawDesc = []byte{
	...
	0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a,
	...
	0x03, 0x6d, 0x73, 0x67, 0x32, 0x31, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x28, 0x0a,
	0x05, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x0d, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x0e, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x73,
...
var file_hello_proto_depIdxs = []int32{
	0, // 0: Hello.hello:input_type -> HelloMessage
	1, // 1: Hello.hello:output_type -> HelloResponse
...
func (c *helloClient) Hello(ctx context.Context, in *HelloMessage, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (*UnimplementedHelloServer) Hello(context.Context, *HelloMessage) (*HelloResponse, error) {
...
func _Hello_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServer).Hello(ctx, req.(*HelloMessage))
	}
